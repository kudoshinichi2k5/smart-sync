...
Assistant answers using uploaded documents and includes citations.
...
screenshots/openai_vector_store.png

```

Shows all Markdown files successfully uploaded.
...
screenshots/github_action_success.png
...
screenshots/github_action_logs.png

```

Shows generated execution logs.
...
Container completes one synchronization successfully.
